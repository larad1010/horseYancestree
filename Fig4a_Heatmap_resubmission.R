...
data<- read.csv(file="Dataset1_revision.csv", header = T, sep = ";")
...
head(combined_data)
colnames(combined_data) <- c("Haplotypes", "Arabians", "Thoroughbreds", "Coldbloods", "Spanish influenced", "Local-Asia", "Total daC")
...
input_list <- c( "daC_Tb-dW1","daC_Tb-dW4","daC_Tb-oB3b","daC_Ao-aA1a","daC*","daC_Ao-a1D2","daC_Ao-nM1a2",
                 ...
                 "daC_T1m","daC_Ad-bF","daC_T1c","daC_Tb1*","daC_Se","daC_Am-aA","daC_Ao-nM2","daC_Tb-oB4",
...
data1<-melt(combined_data, id.vars="Haplotypes")
...
# Save the ggplot 
ggsave("heatmap_res.pdf", plot = gg_heat, bg = "transparent", path="/Users/path/to/saveit", width = 6, height = 8, dpi = 600)  
